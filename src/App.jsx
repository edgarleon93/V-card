...
<div class="grid py-10 place-items-center h-screen w-screen ">
  ...
  <div className="container grid grid-cols-12	h-full">
    ...
    <div className=" col-span-2 sm:col-span-1">
      <a className=" lg:text-2xl md:text-2xl font-medium text-end hover:underline items-center">About</a>
    </div>

    <div className="col-span-12 sm:col-span-12">
      <div class="photo mt-8 mb-8 bg-no-repeat bg-contain	md:w-1/2 "> <img src="/src/image/photo.png" alt="" /> </div>
    </div>

    <div className=" col-span-2 place-items-start h-50 pt-8 ">
